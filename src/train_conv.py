...
def parse_args():
    ...
    parser.add_argument("--output_dir", type=str, default="save/model/conv", help="Where to store the final model.")
    parser.add_argument("--debug", action='store_true', help="Debug mode.")
    # data
    # parser.add_argument("--dataset", type=str, required=True, help="A file containing all data.")
    parser.add_argument("--dataset", type=str, default='redial_conv', help="A file containing all data.")
    ...
    parser.add_argument("--prompt_max_length", default=200, type=int)
    parser.add_argument("--tokenizer", default="../../huggingface/DialoGPT-small", type=str)
    ...
    parser.add_argument("--n_prefix_conv", default=20, type=int)
