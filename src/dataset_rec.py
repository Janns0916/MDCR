...
class CRSRecDataset(Dataset):
    def __init__(
        ...
        # data_file = 'data/redial_rec/valid_data_processed.jsonl'
        self.data = []
...
class CRSRecDataCollator:
    def __init__(
        ...
        self.mids2mmids = json.loads(pkl.load(open('data/lmkg/mids2mmids.pkl', 'rb')))
    ...
    def __call__(self, data_batch):
        ...
        for data in data_batch:
            ...
            movie_label_batch.append(self.mids2mmids[str(data['rec'])])
        ...
        context_batch['movie_rec_labels'] = movie_label_batch
